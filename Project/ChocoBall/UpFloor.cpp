...
void CUpFloor::Initialize(D3DXVECTOR3 pos, D3DXQUATERNION rot, D3DXVECTOR3 scale)
{
	...
	if (scale.z != 1.0f){
		ActivateCollision(D3DXVECTOR3(0.0f, 0.0f, 0.0f), new btBoxShape(btVector3(1.5f * scale.x *0.5f, 0.3f *  scale.y * 0.5f, 1.75f * scale.z * 0.5f)), Collision::Type::Floor,Collision::FilterGroup::Gimmick ,false, 0.0f, true,true);
	}
	else{
